...
const i18n = defineMessages({
  heading: {
    ...
    defaultMessage: 'Help improve SiYuan',
  },
  description: {
    id: 'telemetryConsentPrompt.description',
    defaultMessage:
      'Would you like to share anonymous usage data to help improve SiYuan? We never collect your conversations, code, or personal data.',
  },
  learnMore: {
