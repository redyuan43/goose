...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'SiYuan is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'SiYuan is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'SiYuan is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'SiYuan is compacting the conversation...',
  },
  idle: {
