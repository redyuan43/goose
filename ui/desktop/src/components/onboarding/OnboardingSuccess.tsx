...
const i18n = defineMessages({
  ...
  allSet: {
    ...
    defaultMessage: "You're all set to start using SiYuan.",
  },
  privacyTitle: {
  ...
  privacyDescription: {
    ...
    defaultMessage:
      'Anonymous usage data helps improve SiYuan. We never collect your conversations, code, or personal data.',
  },
  learnMore: {
