...
const i18n = defineMessages({
  title: {
    ...
    defaultMessage: 'SiYuan Server',
  },
  description: {
    id: 'externalBackendSection.description',
    defaultMessage:
      'By default SiYuan launches a server for you, use this to connect to an external SiYuan server',
  },
  useExternalServer: {
  ...
  useExternalServerDescription: {
    ...
    defaultMessage: 'Connect to a SiYuan server running elsewhere (requires app restart)',
  },
  serverUrl: {
  ...
  restartNote: {
    ...
    defaultMessage:
      'Changes require restarting SiYuan to take effect. New chat windows will connect to the external server.',
  },
  urlProtocolError: {
