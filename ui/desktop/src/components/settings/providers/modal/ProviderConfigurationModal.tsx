...
const i18n = defineMessages({
  ...
  addApiKeyDescription: {
    ...
    defaultMessage: 'Add your API key(s) for this provider to integrate into SiYuan',
  },
  oauthLoginFailed: {
  ...
  externalSetupIntro: {
    ...
    defaultMessage: 'This provider is configured outside of SiYuan. Follow these steps:',
  },
  seeDocumentation: {
